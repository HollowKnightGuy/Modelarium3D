...
<head>
    ...
    <link rel="shortcut icon" href="<?= $_ENV['BASE_URL_PUBLIC']?>img/default/logoico.png">   
</head>
...
<body style="cursor:auto;">
    <header>
        <nav class="generic-nav">
            <ul class="header-links">
                ...
                <div class="user-options dnoneresponsive2">
                    ...
                    <?php if (!Utils::isAdmin()) : ?>
                        ...
                        <li class="header-link user-link transition">
                            <a href="<?= $_ENV['BASE_URL'] ?><?= $session ? 'profile/liked' : 'login'; ?>">
                        ...
                        <li class="header-link user-link">
                            <a href="<?= $_ENV['BASE_URL'] ?><?= $session ? 'profile/favs' : 'login'; ?>">
            ...
            <form action="<?= $_ENV['BASE_URL'] ?>models/search" method="POST">
                ...
                <?php if ($session) : ?>
                    <div id="responsive-menu-profilesection">
                        ...
                        <?php if ($session->rol != 'ROLE_ADMIN') : ?>
                            <li>
                                <a class="transition" href="<?= $_ENV['BASE_URL'] ?><?= $session ? 'profile/liked' : 'login'; ?>">
                            ...
                            <li>
                                <a class="transition" href="<?= $_ENV['BASE_URL'] ?><?= $session ? 'profile/favs' : 'login'; ?>">
