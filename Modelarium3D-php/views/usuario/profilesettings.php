...
<?php endforeach; ?>
<title>Modelarium3D - Profile Settings</title>
...
<main class="psmain">
    ...
    <section class="profile-settings-content">
        <article class="profsetsection" id="psprofile">
            <h1>Profile</h1>
            <h2>
                <?php if (isset($_SESSION['editar_perfil_exito']) && $_SESSION['editar_perfil_exito']) :
                    $_SESSION['editar_perfil_exito'] = false; ?>
                    <span class="red-error" style="color:#33a115;display:flex;align-items:center;gap:.7rem;font-size:var(--fs-200);"><?= $tick_img . "Profile update succesful" ?></span>
                <?php endif ?>
            </h2>
