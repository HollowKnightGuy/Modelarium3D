...
<title>Modelarium3D - Model View</title>
    ...
    <div class="model-view-container">
        ...
        <div class="model-view-info">
            ...
            <div class="model-info-2">
                ...
                if ($comprobacion_venta || $modelo->id_usuario === Utils::idLoggedUsuario()) : ?>
            ...
            <?php if (isset($_SESSION['venta_exitosa']) && $_SESSION['venta_exitosa']) :
                $_SESSION['venta_exitosa'] = false; ?>
                <span class="red-error" style="color:#33a115;display:flex;align-items:center;gap:.7rem;font-size:var(--fs-200);"><?= $tick_img . "Model buyed successfully" ?></span>
            <?php endif ?>
            <?php if (isset($_SESSION['editar_modelo_exito']) && $_SESSION['editar_modelo_exito']) :
                $_SESSION['editar_modelo_exito'] = false; ?>
                <span class="red-error" style="color:#33a115;display:flex;align-items:center;gap:.7rem;font-size:var(--fs-200);"><?= $tick_img . "Model updated successfully" ?></span>
            <?php endif ?>
        ...
        <div class="cont-comment-1">
            ...
            <span class="red-error" style="position:relative; top: .8rem; color:#FB7676;">
                ...
                <?php if (isset($_SESSION['esta_reportado'])) : ?>
                    ...
                    <?php unset($_SESSION['esta_reportado']) ?>
                <?php endif; ?>
                <?php if (isset($_SESSION['reportado_exito']) && $_SESSION['reportado_exito']) :
                    $_SESSION['reportado_exito'] = false; ?>
                    <span class="red-error" style="color:#33a115;display:flex;align-items:center;gap:.7rem;font-size:var(--fs-200);"><?= $tick_img . "The comment has been reported, it will be reviewed by the administrators" ?></span>
                <?php endif ?>
                <?php if (isset($error_reportar_tu_comentario) && $error_reportar_tu_comentario != ""): ?>
                    <?= $error_img . $error_reportar_tu_comentario ?>
                    <?php unset($error_reportar_tu_comentario); ?>
                <?php endif; ?>
