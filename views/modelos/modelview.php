            ...
            <div class="model-view-info">
                ...
                <div class="model-info-1">
                    ...
                    <div class="modelview-interactions " >
                        <img src="../img/icons/heart.svg" alt=""><span>24 Likes</span> <img src="<?= $_ENV['BASE_URL_PUBLIC'] ?>img/icons/star.svg" alt=""><span>32 Favorites</span>
                    </div>
                </div>
        ...
        <div class="comment-container">
            ...
            <div class="cont-comment-2">
                ...
                <div class="comment-2-container">
                    ...
                    <img class="report-flag" src="<?= $_ENV['BASE_URL_PUBLIC'] ?>img/icons/flag.svg" alt="report flag">
                </div>
