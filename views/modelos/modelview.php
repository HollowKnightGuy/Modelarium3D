...
<main class="modelview-main">
    ...
    <div class="model-view-container">
        <div class="model-view-card">
            ...
            <div class="model-view-model">
                <img src="<?= $_ENV['BASE_URL_PUBLIC'] ?>img/models/arcade.png" alt="">
            </div>
        ...
        <div class="model-view-info">
            ...
            <div class="model-info-1">
                ...
                <div class="modelview-interactions ">
                    <img src="<?= $_ENV['BASE_URL_PUBLIC'] ?>img/icons/heart.svg" alt=""><span>24 Likes</span> <img src="<?= $_ENV['BASE_URL_PUBLIC'] ?>img/icons/star.svg" alt=""><span>32 Favorites</span>
                </div>
            </div>
    ...
    <div class="comment-container">
        ...
        <div class="cont-comment-1">
            ...
            <div class="comment-1">
                <form action="<?= $_ENV['BASE_URL'] ?>"></form>
