...
<main>
    <div class="about-us-container">
        <img id="loop1" class="loop" src="<?= $_ENV['BASE_URL'] ?>img/about-us/3d_loop_1.png" alt="deco">
        <img id="loop2" class="loop" src="<?= $_ENV['BASE_URL'] ?>img/about-us/3d_loop_2.png" alt="deco">

        <div class="about-us-card">
            <a href="https://github.com/Pablogrammer" target="blank" class="about-us-gitlink">
                <div class="about-us-card-1">
                    <img class="about-us-profile transition" src="<?= $_ENV['BASE_URL'] ?>img/about-us/profile1.png" alt="profileimg1">
            ...
            <a href="https://github.com/HollowKnightGuy" target="blank">
                <div class="about-us-card-2">
                    ...
                    <img class="about-us-profile transition" src="<?= $_ENV['BASE_URL'] ?>img/about-us/profile2.png" alt="profileimg2">
                </div>
            </a>
        </div>
    </div>
