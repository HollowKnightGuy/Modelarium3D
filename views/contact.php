...
?>
    ...
    <div class="contact-img-container">
        <img class="bg-contact" src="<?= $_ENV['BASE_URL']?>img/contact/DALL·E 2023-05-19 12.31.29 - retro arade sunset.png" alt="">
    </div>
            ...
            <form class="contact-form" action="#">
                <div class="section section1">
                    <div class="contact-name">
                        <img src="<?= $_ENV['BASE_URL']?>img/contact/input.png" alt="">
                ...
                <div class="section contact-description">
                    <img src="<?= $_ENV['BASE_URL']?>img/contact/big-input.png" alt="">
